...
OUT = r'D:\111-1\AI_Scientist_v2\backend\output\experiments\6'
CDIR = r'D:\111-1\AI_Scientist_v2\backend\output\experiments\6\charts'
_CHARTS = []
...
data = {
    ...
    'space': np.random.uniform(0, 10, 100),
    'dark_matter_content': np.random.normal(27, 5, 100),
    'observation_technology_level': np.random.choice(['low', 'medium', 'high'], 100),
    'model_choice': np.random.choice(['WIMPs', 'Axions', 'NewForce'], 100)
}
...
df = df[df['dark_matter_content'] > 0]  # 删除负值
