...
OUT = r'D:\111-1\AI_Scientist_v2\backend\output\experiments\902'
CDIR = r'D:\111-1\AI_Scientist_v2\backend\output\experiments\902\charts'
_CHARTS = []

_DF_JSON = '{"columns": ["x", "y"], "rows": [[1, 100], [2, 200], [3, 300]]}'
